...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_posts', 'meta_description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Post.meta_title'
        db.add_column('blog_posts', 'meta_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Post.meta_keywords'
        db.add_column('blog_posts', 'meta_keywords', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Post.meta_description'
        db.delete_column('blog_posts', 'meta_description')

        # Deleting field 'Post.meta_title'
        db.delete_column('blog_posts', 'meta_title')

        # Deleting field 'Post.meta_keywords'
        db.delete_column('blog_posts', 'meta_keywords')
    ...
    models = {
        ...
        'blog.post': {
            ...
            'abstr': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
