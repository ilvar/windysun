...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaffMember.gallery'
        db.add_column('surfblog_staffmember', 'gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StaffMember.gallery'
        db.delete_column('surfblog_staffmember', 'gallery_id')
