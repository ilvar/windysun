...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.ordering'
        db.add_column('surfblog_article', 'ordering', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.ordering'
        db.delete_column('surfblog_article', 'ordering')
