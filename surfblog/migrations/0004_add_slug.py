...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StaffMember.slug'
        db.add_column('surfblog_staffmember', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StaffMember.slug'
        db.delete_column('surfblog_staffmember', 'slug')
