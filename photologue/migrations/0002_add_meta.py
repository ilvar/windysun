...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.meta_description'
        db.add_column('photologue_gallery', 'meta_description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Gallery.meta_title'
        db.add_column('photologue_gallery', 'meta_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Gallery.meta_keywords'
        db.add_column('photologue_gallery', 'meta_keywords', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Gallery.meta_description'
        db.delete_column('photologue_gallery', 'meta_description')

        # Deleting field 'Gallery.meta_title'
        db.delete_column('photologue_gallery', 'meta_title')

        # Deleting field 'Gallery.meta_keywords'
        db.delete_column('photologue_gallery', 'meta_keywords')
